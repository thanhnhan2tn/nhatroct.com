...
<form name="check" onsubmit="return checkpost()" action="postProcess.php" method="post" enctype="multipart/form-data">  <!-- 
    ...
    <div class="row">
		...
		<div class="row">
			...
			<div class="col-md-10">
				<div><input class="form-control" id="sonha" maxlength="100" name="sonha" maxlength="40" placeholder="Nhập số nhà" type="text" value="<?php echo (isset($_POST['sonha'])) ? $_POST['sonha'] : ''; ?>" required/>
